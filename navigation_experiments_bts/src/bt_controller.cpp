...
int main(int argc, char ** argv)
{
  ...
  factory.registerFromPlugin(loader.getOSName("navigation_experiments_bts_navigate_to_wp_bt_node"));
  factory.registerFromPlugin(loader.getOSName("navigation_experiments_bts_recharge_bt_node"));
