...
#include "navigation_experiments_bts/behavior_tree_nodes/Recharge.hpp"
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<navigation_experiments_bts::Recharge>(
        name, config);
    };

  factory.registerBuilder<navigation_experiments_bts::Recharge>(
    "Recharge", builder);
}
