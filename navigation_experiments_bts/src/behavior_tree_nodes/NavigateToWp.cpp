...
#include "navigation_experiments_bts/behavior_tree_nodes/NavigateToWp.hpp"
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<navigation_experiments_bts::NavigateToWp>(
        name, "navigate_to_pose_qos", config);
    };

  factory.registerBuilder<navigation_experiments_bts::NavigateToWp>(
