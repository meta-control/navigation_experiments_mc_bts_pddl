...
TEST(pilot_test, main)
{
  ...
  // Here should go the content of main() in navigation_experiments_bts.cpp

  std::string pkgpath = ament_index_cpp::get_package_share_directory("navigation_experiments_bts");
  std::string xml_file = pkgpath + "/behavior_trees/bt.xml";

  BT::BehaviorTreeFactory factory;
  BT::SharedLibrary loader;
  factory.registerFromPlugin(loader.getOSName("navigation_experiments_bts_deliver_order_bt_node"));
  factory.registerFromPlugin(loader.getOSName("navigation_experiments_bts_interact_with_barman_bt_node"));
  factory.registerFromPlugin(loader.getOSName("navigation_experiments_bts_get_order_bt_node"));
  factory.registerFromPlugin(loader.getOSName("navigation_experiments_bts_navigate_to_barman_bt_node"));
  factory.registerFromPlugin(loader.getOSName("navigation_experiments_bts_navigate_to_client_bt_node"));
