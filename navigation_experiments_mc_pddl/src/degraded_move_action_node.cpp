...
class DegradedMove : public plansys2::ActionExecutorClient
{
public:
  DegradedMove()
  : plansys2::ActionExecutorClient("degraded_move", 1s)
  {
    ...
    pos_sub_ = create_subscription<geometry_msgs::msg::PoseWithCovarianceStamped>(
      "/amcl_pose",
      10,
      std::bind(&DegradedMove::current_pos_callback, this, _1));
  }
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<DegradedMove>();
